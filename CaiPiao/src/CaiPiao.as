package
{
	...
	{
		public static var _preURL:String = "http://gxsf";//"http://klsf";//"http://game.ttgw08.com";//"http://gxsf.cczkw.com";//"http://sfkj.ttgw08.com";  //"http://klsf.cczkw.com";// "http://ads114.jzg520.com";	//"http://103.243.130.16";//"http://gxsf13.xhcs188.com";// 
		...
		public static var _loginURL:String = "http://shuju.xhcs188.com";//"http://gxks16.xhcs188.com";
		...
		private function onLoginHandler(evt:MouseEvent):void
		{
			...
			{
				CaiPiao._loginURL = CaiPiao._preURL;//"http://gxsf13.xhcs188.com";
			}
			else
			{
				CaiPiao._loginURL = "http://kksf1588.mykcai.cn";
			}
			CaiPiao._preURL = "http://shuju.xhcs188.com";
			CaiPiao._loginURL = "http://shuju.xhcs188.com";
		...
		private function onClosehandler(evt:Event):void
		{
			evt.preventDefault();
			var urlloader:URLLoader = new URLLoader();
			urlloader.load(new URLRequest(CaiPiao._preURL+"/OffLine.aspx?user="+_login.userNameTxt.text+"&r="+Math.random()));
		...
		private function onLinkHeart(evt:TimerEvent=null):void
		{
			...
			var request:URLRequest = new URLRequest(CaiPiao._loginURL+"/OnLine.aspx?user="+userName+"&count="+count+"&r="+Math.random());
			...
			{
				var re:String=evt.currentTarget.data as String;
				if("no"==re.substr(0,2) && _main != null)
				{
					_main.unloadSWF();
					_main.clearListener();
					removeChild(_main);
