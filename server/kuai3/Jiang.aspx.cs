        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    string nextdate = "";
                    if (minute%10 < 7)
                        nextdate = month + "/" + day + "/" + year + " " + hour + ":" + ((minute / 10) * 10 + 7) + ":00";
                    else if (minute >=47)
                        nextdate = month + "/" + day + "/" + year + " " + hour + ":57:00";
                    else
                        nextdate = month + "/" + day + "/" + year +" " + hour + ":" + ((minute / 10) * 10 + 17) + ":00";
                    if (cas < 9.19)
                        nextdate = month + "/" + day + "/" + year +" 09:37:00";
                    if (cas > 22.27)
                        nextdate = month + "/" + day_add + "/" + year + " 09:37:00";
