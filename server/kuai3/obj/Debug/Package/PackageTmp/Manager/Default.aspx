            ...
            <td width="100%" height="50" colspan="3" style="border-bottom: 1px solid #000000">
                <table height="49" border="0" cellspacing="0" cellpadding="0" width="100%" class="font_size">
                    <tr>
                        ...
                        <td width="380" style="background-repeat: no-repeat; "  >
                        <b>&nbsp;抽奖系统</b>
                        </td> 
        ...
        <tr>
            ...
            <td style="width: 100%">
                <iframe id="mainFrame" name="mainFrame" style="height: 100%; visibility: inherit;
                    width: 100%; z-index: 1" scrolling="auto" frameborder="0" src="main.htm"></iframe>
            </td>
        </tr>
        <%
            break;
        ...
        <tr>
            <td colspan="3" height="20">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" height="20">
                    <tr>
                        <td class="down_text">
                            <a href="#" target="_blank"><font >&nbsp;</font></a>
                            </td>
                            <td align="right" width="300" bgcolor="#000000">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td style="cursor:pointer;border-left:1px solid #FFFFFF;" onclick="javascript:showPopWin('个人设定','UserSet_Pas.aspx?rand'+rand(100000000),400, 255, AlertMessageBox,true)">&nbsp;<img src="images/userset.gif" style="margin-bottom: -3px">&nbsp;<font color="#FFFFFF">个人设定</font></td>
                                    <td style="cursor:pointer;border-left:1px solid #FFFFFF;" onclick="javascript: window.mainFrame.location.href='main.htm'">&nbsp;<img src="images/house.gif" style="margin-bottom: -3px">&nbsp;<font color="#FFFFFF">回到首页</font></td>
                                  ...
                                  <%--  <td style="cursor:pointer;border-left:1px solid #FFFFFF;" onclick="javascript:window.open('http://framework.songyecc.com/help/');">&nbsp;<img src="images/help.gif" style="margin-bottom: -3px">&nbsp;<font color="#FFFFFF">帮助手册</font></td>--%>
                                </tr>
                            </table>
