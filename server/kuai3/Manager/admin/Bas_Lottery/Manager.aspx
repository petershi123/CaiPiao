            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="Stage_Input" title="请输入期号" runat="server" CssClass="text_input"></asp:TextBox>如：131029001
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="Num1_Input" title="请输入第一球" runat="server" CssClass="text_input"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="Num2_Input" title="请输入第二球" runat="server" CssClass="text_input"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="Num3_Input" title="请输入第三球" runat="server" CssClass="text_input"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="OpenTime_Input" runat="server" CssClass="text_input"></asp:TextBox>
                    
                        <asp:Label ID="OpenTime_Disp" runat="server"></asp:Label></td>
                </tr><%--
