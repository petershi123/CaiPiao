        ...
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="开奖列表">
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting" OnRowCreated="GridView1_RowCreated" >
                <Columns>
                    ...
                    <asp:BoundField HeaderText="平一" SortExpression="Num1" DataField="Num1" />
                    <asp:BoundField HeaderText="平二" SortExpression="Num2" DataField="Num2" />
                    <asp:BoundField HeaderText="平三" SortExpression="Num3" DataField="Num3" />
                    <asp:BoundField HeaderText="平四" SortExpression="Num4" DataField="Num4" />
