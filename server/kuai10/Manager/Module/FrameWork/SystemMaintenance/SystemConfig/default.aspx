            ...
            <tr>
                ...
                <tr>
                    ...
                    <td class="table_none" >
                        ...
                        <asp:TextBox ID="tb_S_Version" runat="server" CssClass="text_input" 
                            title="请输入系统版本~20:!"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <font color="red">使用此功能，可能导致Ajax远程读取数据无效!</font> </td>
                </tr>                
                <tr>
                    <td class="table_body">
                        IP地址查询链接</td>
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="tb_C_IPLookUrl" runat="server" Columns="60" 
                            CssClass="text_input" title="IP地址查询链接~255:!"></asp:TextBox>
                    </td>
                </tr>
                <tr>
